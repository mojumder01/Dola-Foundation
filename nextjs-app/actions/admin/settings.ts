...
export async function updateSiteSettings(formData: FormData) {
  try {
    ...
    const data = {
      ...
      siteNameBn: (formData.get("siteNameBn") as string) || undefined,
      tagline: (formData.get("tagline") as string) || undefined,
      taglineBn: (formData.get("taglineBn") as string) || undefined,
      ...
      heroTitleBn: (formData.get("heroTitleBn") as string) || undefined,
      heroSubtitle: formData.get("heroSubtitle") as string,
      heroSubtitleBn: (formData.get("heroSubtitleBn") as string) || undefined,
      heroImage: (formData.get("heroImage") as string) || undefined,
      announcementText: (formData.get("announcementText") as string) || undefined,
      announcementTextBn: (formData.get("announcementTextBn") as string) || undefined,
      announcementEnabled: formData.get("announcementEnabled") === "true",
      aboutText: (formData.get("aboutText") as string) || undefined,
      aboutTextBn: (formData.get("aboutTextBn") as string) || undefined,
      missionText: (formData.get("missionText") as string) || undefined,
      missionTextBn: (formData.get("missionTextBn") as string) || undefined,
      visionText: (formData.get("visionText") as string) || undefined,
      visionTextBn: (formData.get("visionTextBn") as string) || undefined,
      founderName: (formData.get("founderName") as string) || undefined,
      founderNameBn: (formData.get("founderNameBn") as string) || undefined,
      founderMessage: (formData.get("founderMessage") as string) || undefined,
      founderMessageBn: (formData.get("founderMessageBn") as string) || undefined,
      ...
      donatePageTitleBn: (formData.get("donatePageTitleBn") as string) || undefined,
      donatePageSubtitle: (formData.get("donatePageSubtitle") as string) || undefined,
      donatePageSubtitleBn: (formData.get("donatePageSubtitleBn") as string) || undefined,
      ...
      footerMissionTextBn: (formData.get("footerMissionTextBn") as string) || undefined,
      ...
      aboutStat1LabelBn: (formData.get("aboutStat1LabelBn") as string) || undefined,
      ...
      aboutStat2LabelBn: (formData.get("aboutStat2LabelBn") as string) || undefined,
      ...
      aboutStat3LabelBn: (formData.get("aboutStat3LabelBn") as string) || undefined,
      ...
      aboutStat4LabelBn: (formData.get("aboutStat4LabelBn") as string) || undefined,
      stat1LabelBn: (formData.get("stat1LabelBn") as string) || undefined,
      stat2LabelBn: (formData.get("stat2LabelBn") as string) || undefined,
      stat3LabelBn: (formData.get("stat3LabelBn") as string) || undefined,
      stat4LabelBn: (formData.get("stat4LabelBn") as string) || undefined,
    };
