...
export default async function BlogPage() {
  ...
  const bannerTextColor = (settings as any)?.blogBannerTextColor || "#FFFFFF";
  const bannerBadge = (settings as any)?.blogBannerBadge || "Blog";
  const bannerTitle = (settings as any)?.blogBannerTitle || "Stories & Insights";
  const bannerSubtitle =
    (settings as any)?.blogBannerSubtitle ||
