...
export default async function AboutPage() {
  ...
  const bannerTextColor = (settings as any)?.aboutBannerTextColor || "#FFFFFF";
  const bannerBadge = (settings as any)?.aboutBannerBadge || "About Us";
  const bannerTitle = (settings as any)?.aboutBannerTitle || "Who We Are";
  const bannerSubtitle =
    (settings as any)?.aboutBannerSubtitle ||
